...
define({
    ...
    // ALERT_TIP_UPDATE_ILLEGAL : '<p>「{1}」new version has a different app signature.</p><p> If you want to continue updating, SnapPea will help you uninstall the old version and remove the old app data. </p><p>Continue?</p>',
    // ALERT_TIP_UPDATE_NOT_RECOMMENDED : '<p>{1}</p><p>Continue?</p>',
    // ALERT_TIP_UPDATE_ILLEGAL_SYSTEM_UNROOT : '<p>「{1}」new version has a different app signature.</p><p>Because this is a system app, you need root permission to update. </p><p>Continue?</p>',
    ...
    // CHANGE_VERIFICATION_CODE : 'Refresh',

    // CHECK : 'Check',
    // YOUR_FAVORITE_APP_TYPE : 'Your favorite app category',
    // LAST_APP_LIST : 'New lists',
    // SUBMIT : 'Submit',
    // NEXT : 'Next',
    // CLOSED : 'Close',
    // NO : 'Not available',
